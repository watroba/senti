...
d ={"0":("Arkansas","De Witt",19019,34.2354,-91.2891),
        ...
        "29":("HotSpring","Malvern",32923,34.3394,-92.9776),
        ...
        "40":("LittleRiver","Ashdown",13171,33.6809,-94.1923),
        ...
        "61":("StFrancis","Forrest",28258,34.9927,-90.7153),
        ...
        "70":("VanBuren","Clinton",17295,35.6266,-92.5396),
